...
@section('main')
<section class="relative min-h-screen bg-center bg-no-repeat bg-cover main flex justify-center items-center pb-20" style="background-image:url('/images/bg-1.png')">
